    ...
    <div className='fixed w-full h-[96px] display-none md:flex bg-[rgba(16,16,16,0.5)] top-0 left-0 items-center justify-between'>
      ...
      <div className='flex justify-between gap-40 mr-12 items-center'>
        <div className='w-fit text-[20px] text-secondary flex gap-10'>
          <div className='cursor-pointer hover:bg-gradient hover:bg-clip-text hover:text-transparent transition-all duration-200 ease-linear '>About</div>
          <div className='cursor-pointer hover:bg-gradient hover:bg-clip-text hover:text-transparent transition-all duration-200 ease-linear '>Experience</div>
          <div className='cursor-pointer hover:bg-gradient hover:bg-clip-text hover:text-transparent transition-all duration-200 ease-linear '>Projects</div>
        </div>
