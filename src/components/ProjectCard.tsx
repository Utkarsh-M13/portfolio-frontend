...
const ProjectCard = ({title, description, link, github, src, technologies} : Props) => {
  ...
  return (
    <div className='w-[300px] lg:w-[720px] min-h-[200px] rounded-xl flex flex-col-reverse lg:flex-row gap-8 hover:bg-[#F5F5F5]/12.5 px-6 py-3 relative'>
      <div className='font-light text-sm pt-2'><img width={144} src={src} alt="" /></div>
      <div className='flex flex-col w-60 lg:w-120'>
        ...
        <a href={github}>
          ...
          <path d="M10 18.3332C14.6024 18.3332 18.3334 14.6022 18.3334 9.99984C18.3334 5.39746 14.6024 1.6665 10 1.6665C5.39764 1.6665 1.66669 5.39746 1.66669 9.99984C1.66669 14.6022 5.39764 18.3332 10 18.3332Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <path d="M8.05558 14.7515C6.38891 15.2779 5.00002 14.7515 4.16669 13.1287" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </g>
          <defs>
